...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // Check if user has an exhibitor profile
            ...
            <div className="flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div className="text-center md:text-left">
                        <h2 className="text-2xl font-bold text-gray-900">出店者ログイン</h2>
                        <p className="mt-2 text-sm text-gray-500">
                            アカウント情報を入力してポータルへアクセス
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-sm">
                                <Link href="/forgot-password" size="sm" className="font-medium text-emerald-600 hover:text-emerald-500">
                                    パスワードをお忘れですか？
                                </Link>
                            </div>
                        </div>
