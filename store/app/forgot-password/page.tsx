        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <div className="text-center">
                    <Link href="/login" className="inline-flex items-center text-sm text-gray-500 hover:text-emerald-600 mb-6 transition-colors font-medium">
                ...
                {isSubmitted ? (
                    <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="flex justify-center mb-4">
                            <div className="bg-emerald-600 rounded-full p-3 text-white shadow-lg shadow-emerald-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="email"
                                    required
                                    className="block w-full pl-10 rounded-lg border-gray-300 bg-gray-50 p-3.5 text-gray-900 outline-none focus:bg-white focus:ring-2 focus:ring-emerald-200 focus:border-emerald-500 transition-all font-medium border"
                        ...
                        <Button
                            type="submit"
                            size="lg"
                            className="w-full font-bold shadow-lg shadow-emerald-100 bg-emerald-600 hover:bg-emerald-700"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                                <>
