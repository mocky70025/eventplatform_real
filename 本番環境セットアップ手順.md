...
4. チャネル情報を入力：
   - **チャネル名**: 出店者用チャネル（例: "Tomorrow Event Platform - Store"）
   - **チャネル説明**: 任意
   - **アプリタイプ**: Webアプリ
   - **メールアドレス**: 任意
5. 作成後、**チャネルID**と**チャネルシークレット**をメモ

### 2. 主催者用チャネルを作成

1. 同じプロバイダー内で「新規チャネル作成」→「LINE Login」を選択
2. チャネル情報を入力：
   - **チャネル名**: 主催者用チャネル（例: "Tomorrow Event Platform - Organizer"）
   - **チャネル説明**: 任意
   - **アプリタイプ**: Webアプリ
   - **メールアドレス**: 任意
3. 作成後、**チャネルID**と**チャネルシークレット**をメモ
...
NEXT_PUBLIC_LINE_LOGIN_CHANNEL_ID=<出店者用チャネルID>
LINE_LOGIN_CHANNEL_SECRET=<出店者用チャネルシークレット>
...
NEXT_PUBLIC_LINE_LOGIN_CHANNEL_ID=<主催者用チャネルID>
LINE_LOGIN_CHANNEL_SECRET=<主催者用チャネルシークレット>
