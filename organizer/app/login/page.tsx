...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log('  profileError:', profileError ? JSON.stringify(profileError, null, 2) : null);

            if (profileError) {
                console.error('Error fetching profile in login:', profileError);
                // If it's an RLS error, show error message
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
            {/* Left: Branding */}
            <div className="hidden md:flex flex-col justify-between bg-orange-600 p-10 text-white">
                <div>
                    <div className="flex items-center gap-2 mb-20">
                        <Tent className="h-8 w-8" />
                        <span className="text-2xl font-bold tracking-tight">Organizer</span>
                    </div>
            ...
            <div className="flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-sm">
                                <Link href="/forgot-password" size="sm" className="font-medium text-orange-600 hover:text-orange-500">
                                    パスワードをお忘れですか？
                                </Link>
                            </div>
                        </div>
                        ...
                        <Button
                            type="submit"
                            size="lg"
                            className="w-full font-bold shadow-orange-200"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                                <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        {/* Custom LINE Login */}
                        <Button
                            className="w-full flex items-center justify-center bg-[#06C755] hover:bg-[#05b34c] text-white border-transparent"
