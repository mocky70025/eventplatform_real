...
export default function SellerEventDetailPreview() {
  return (
    <div style={{
      minHeight: '100vh',
      width: '100%',
      ...
      <div style={{
        ...
        height: '200px',
        borderRadius: '16px',
        background: 'linear-gradient(135deg, #FF8A5C 0%, #FF6B3D 100%)',
        marginBottom: '16px',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '2px' }}>
