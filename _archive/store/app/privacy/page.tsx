    ...
    <div style={{
      ...
      <div style={{
        ...
        <Section title="1. 収集する情報">
          出店登録や申込処理に必要な氏名・連絡先・店舗情報、ログイン認証で必要となる識別子やアクセスログ等を取得します。
        </Section>

        <Section title="2. 利用目的">
          出店申込の管理、本人確認・不正防止、運営からの連絡、サービス品質向上のための分析に利用します。
        </Section>

        <Section title="3. 第三者提供・委託">
          法令に基づく場合や、業務委託先への必要最小限の提供を除き、同意なく第三者へ提供しません。
        </Section>

        <Section title="4. セキュリティ">
          SSL/TLS等による通信の保護、アクセス制御など適切な安全管理措置を講じます。
        </Section>
